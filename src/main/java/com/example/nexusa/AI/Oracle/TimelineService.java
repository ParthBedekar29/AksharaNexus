...
public class TimelineService {
    ...
    public List<TimelineEvent> buildTimeline(String civilizationName) {
        ...
        Set<String> seenKeys = new LinkedHashSet<>();  // ← add this
        ...
        for (CentralEntry entry : entries) {
            try {
                ...
                for (JsonNode node : arr) {
                    ...
                    String descKey = title + "|" + description;  // ← add this
                    if (seenKeys.contains(descKey)) continue;     // ← and this
                    seenKeys.add(descKey);                        // ← and this
